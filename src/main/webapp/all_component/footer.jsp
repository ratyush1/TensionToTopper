<div class="container-fluid bg-color mt-1 p-2"
    ...
    <p class="text-center text-white p3">@Depiction plus flourish moreover extent orbit</p>
</div>
<!-- Footer -->
<style>
    @charset "UTF-8";
        ...
        <div class="footer-grid">
            <div>
                ...
                <p class="footer-description">
                    Transforming academic tension into success through comprehensive e-learning solutions.
                </p>
